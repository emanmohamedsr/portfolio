	...
	return (
		<Sheet defaultOpen={true} open={isOpen} onOpenChange={handleClose}>
			<SheetContent
				side='top'
				aria-label='Loading'
				className='z-1000 flex h-screen w-screen items-center justify-center border-none bg-slate-950 p-0 overflow-hidden [&>button:not(.skip)]:hidden'>
				...
				<div className='absolute top-0 z-0 w-full flex-1 scale-y-125 items-center justify-center isolate hidden md:flex'>
					<div
						...
						<div className='absolute w-screen left-0 bg-slate-950 h-40 bottom-0 z-20 mask-[linear-gradient(to_top,white,transparent)]' />
						<div className='absolute w-40 h-screen left-0 bg-slate-950 bottom-0 z-20 mask-[linear-gradient(to_right,white,transparent)]' />
					</div>
					...
					<div
						...
						<div className='absolute w-40 h-screen right-0 bg-slate-950 bottom-0 z-20 mask-[linear-gradient(to_left,white,transparent)]' />
						<div className='absolute w-screen right-0 bg-slate-950 h-40 bottom-0 z-20 mask-[linear-gradient(to_top,white,transparent)]' />
					</div>

					{/* Decorative Blurs & Lines */}
